...
public class IsochroneActivity extends AppCompatActivity implements MapboxMap.OnMapClickListener {
  ...
  private String[] contourColors = new String[] {"80f442", "403bd3", "bc404c"};
  private int[] contourMinutes = new int[] {14, 35, 53};
  ...
  private void makeIsochroneApiCall(@NonNull Style style, @NonNull LatLng mapClickPoint) {
    ...
    mapboxIsochroneRequest.enqueueCall(new Callback<FeatureCollection>() {
      ...
      public void onResponse(Call<FeatureCollection> call, Response<FeatureCollection> response) {
        ...
        Log.d("Isochrone", "onResponse: request url = " + call.request().url());
      ...
      public void onFailure(Call<FeatureCollection> call, Throwable t) {
        Timber.d("Request failed: %s", t.getMessage());
      }
    });
  }
